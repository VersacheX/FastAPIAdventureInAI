...
from services.memory_service import calculate_token_count, verify_game_ownership
...
async def create_deep_memory(
    ...
    token_count = calculate_token_count(deep_memory.summary)
...
async def update_deep_memory(
    ...
    deep_memory.token_count = calculate_token_count(update.summary)
